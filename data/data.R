...
rownames(df2018) <- df2018$country
...
rownames(df2019) <- df2019$country
...
train <- rbind(df2015_clean, df2016_clean, df2017_clean, df2018_clean)
test <- df2019_clean

write.csv(train, "happiness_train.csv")
write.csv(test, "happiness_test.csv")
